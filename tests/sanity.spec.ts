...
test(
  "Sanity - New user login and executing a Wheelspin | Data Verification ",
  async ({ stateContext, loginData, wheelSpinData }) => {
    ...
    await test.step('Validating WheelSpin data stored in context', async () => {
